...
//	HAL_UART_Transmit(&huart3,rx_buf,1,HAL_MAX_DELAY);
////	switch(rx_buf[0])
////	{
////		case 0x01:
////		break;
...
////	}
	...
	else if(Bluetooth_data==0x03) Fore=0,Back=1,Left=0,Right=0;//ºó
	else if(Bluetooth_data==0x05) Fore=0,Back=0,Left=1,Right=0;//×ó
